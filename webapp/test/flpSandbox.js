		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "rams_git",
									"targetURL": "#ramsgitramsgit-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ramsgitramsgit-display": {
								"semanticObject": "ramsgitramsgit",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ramsgit.ramsgit",
									"url": sap.ui.require.toUrl("ramsgit/ramsgit")
								}
							}
						}
					}
